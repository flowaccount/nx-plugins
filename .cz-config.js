module.exports = {
    types: [
      ...
      { value: 'cleanup', name: 'cleanup:  A code change that neither fixes a bug nor adds a feature' },
      { value: 'chore', name: "chore:    Other changes that don't modify src or test files" }
    ],
    scopes: [
      { name: 'nx-serverless', description: 'anything nx-serverless specific' },
      { name: 'core', description: 'anything infrastructure as a code core specific' },
      ...
      { name: 'testing', description: 'anything testing specific (e.g., jest or cypress)'},
