...
import { ApplicationListenerRule, ApplicationTargetGroup, IApplicationTargetGroup, ListenerCondition } from '@aws-cdk/aws-elasticloadbalancingv2';
...
export class ApplicationTargetGroupStack extends Stack {
  ...
  constructor(scope: Construct, id: string, _props: ApplicationTargetGroupStackProperties) {
    ...
    if(!_props.applicationtargetGroupProps.targetGroupName) {
      ...
      const applicationListenerRule = new ApplicationListenerRule(this, `${_props.apiDomain}-listener-rule`, {
