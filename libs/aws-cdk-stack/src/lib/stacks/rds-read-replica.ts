import { DatabaseInstance, DatabaseInstanceReadReplica, IDatabaseInstance } from "@aws-cdk/aws-rds";
...
export class RdsReadReplicaStack extends Stack {
    ...
    constructor(scope: Construct, id: string, _props: DatabaseReadonlyReplicaProps) {
      super(scope, id, _props);
          ...
          const _instance = DatabaseInstance.fromDatabaseInstanceAttributes(scope, id, _props.instanceAttributes)
          logger.info(`creating database read replica:${id}-read-replica:`)
          const readReplica = new DatabaseInstanceReadReplica(this, `${id}-read-replica`, {
